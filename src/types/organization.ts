import { Organization, User, Ebook, Redemption, PointsImport } from '@prisma/client';

// Tipos base do Prisma
export type { Organization, User, Ebook, Redemption, PointsImport, UserRole, ImportStatus } from '@prisma/client';
...
// Tipos para páginas
export interface OrganizationLoginPageProps {
  organization: Organization;
}
...
export interface OrganizationStats extends DashboardStats {
  recentImports: PointsImport[];
  topEbooks: (Ebook & { redemptionCount: number })[];
}
