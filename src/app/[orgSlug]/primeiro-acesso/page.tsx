      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-gray-500 mt-2">Configure sua senha para acessar seus ebooks</p>
          </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              Já tem uma conta?{' '}
              <a href={`/${organization.slug}/login`} className="text-blue-600 hover:text-blue-500 font-medium">
                Fazer login
              </a>
            </p>
          </div>
