...
export default async function OrganizationLoginPage({ params }: OrganizationLoginPageProps) {
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-gray-500 mt-2">Entre com seu CPF e senha para resgatar seus ebooks</p>
          </div>
